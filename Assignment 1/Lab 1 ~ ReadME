...
My first primary focus was to root out my 3 epics’. I decided them by goal or the main goal, so the first one is the delivery side of course, the second the store side, and then the last one is the user side because that was the labs main focus. 
...
I found this lab very fun, and I loved being able to play around with the features inside the story board, I will probably use it again in the future since it's fun to use.
